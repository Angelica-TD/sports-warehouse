    ...
    <fieldset>
        ...
        <div class="input-group">
            <div class="input-container">
                <input class="floating" type="text" id="firstName" name="firstName" placeholder="" required <?= setValue("firstName") ?>>
            ...
            <div class="input-container">
                <input class="floating" type="text" id="lastName" name="lastName" placeholder="" required <?= setValue("lastName") ?>>
        ...
        <div class="input-group">
            <div class="input-container">
                <input class="floating" type="tel" name="contactNumber" id="contactNumber" placeholder="" <?= setValue("contactNumber") ?>>
                <label class="ud-label" for="contactNumber">Contact number</label>
            </div>

            <div class="input-container">
                <input class="floating" type="email" name="emailAddress" id="emailAddress" placeholder="" required <?= setValue("emailAddress") ?>>
        ...
        <div class="input-single">
            ...
            <div class="input-container">
                <input class="floating" type="text" id="streetAddress" name="streetAddress" placeholder="" required <?= setValue("streetAddress") ?>>
        ...
        <div class="input-group">
            ...
            <div class="input-container">
                <input class="floating" type="text" id="suburb" name="suburb" placeholder="" required <?= setValue("suburb") ?>>
            ...
            <div class="input-container">
                <input class="floating" type="text" id="postcode" name="postcode" placeholder="" required <?= setValue("postcode") ?>>
